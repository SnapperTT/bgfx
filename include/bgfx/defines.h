...
#define BGFX_BUFFER_BLIT_DST                      UINT16_C(0x2000) //!< Buffer will be used as a target for blitting.
...
#define BGFX_CAPS_BUFFER_BLIT                     UINT64_C(0x0000000100000000) //!< Buffer blit is supported.
